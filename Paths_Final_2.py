...
class Cars():
    ...
    def __init__(self, quantity):
        ...
        self.route_dist = [[0 for column in range(1)]
                      for row in range(quantity)]
ev = Cars(noCar)
q = np.genfromtxt(r"C:\Users\prath\OneDrive\Desktop\EV PROJECT\EV.csv", delimiter=',')
q = q.tolist()
ev.stats = q

r = np.genfromtxt(r"C:\Users\prath\OneDrive\Desktop\EV PROJECT\Nodes.csv", delimiter=',')
r = r.tolist()
r[0][0] = 0
